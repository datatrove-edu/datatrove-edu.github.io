...
Annual deforestation in Brazil has lots of variation and some noticeable maximum values.

<!--more-->

{{< figure src="deforestationBrazilGraph.png" width="700px" caption="Graph built from data from [TerraBrasilis/INPE](https://terrabrasilis.dpi.inpe.br/app/dashboard/deforestation/biomes/legal_amazon/rates). Per data license, image licensed Creative Commons Attribution-ShareAlike 4.0 (CC BY-SA 4.0)." >}}
