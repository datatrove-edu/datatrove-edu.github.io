...
This corresponds to a doubling time of approximately 2 years.

{{< figure src="pubmed_ai_publications.png" width="700px" caption="Number of AI-related publications by year according to PubMed together with exponential fit.<br/>Graph created with PubMed search data linked below." >}}
...
Data was obtained by performing this [search](https://pubmed.ncbi.nlm.nih.gov/?term=%28artificial+intelligence%5Btiab%5D+OR+machine+learning%5Btiab%5D%29+AND+humans%5Bmesh%5D+AND+english%5Blang%5D) on [PubMed](https://pubmed.ncbi.nlm.nih.gov). 
